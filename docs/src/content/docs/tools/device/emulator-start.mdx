...
<Aside type="note">
  On clients that support it, this tool reports MCP progress notifications while it waits for the emulator to attach and boot, and can be cancelled mid-wait.
</Aside>
